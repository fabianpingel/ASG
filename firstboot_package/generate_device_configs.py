...
def main() -> None:
    ...
    parser.add_argument("--wifi-ssid", required=True, help="WLAN SSID")
    parser.add_argument("--wifi-psk", required=True, help="WLAN Passwort")
    parser.add_argument("--wifi-country", default="DE")
    parser.add_argument("--host-prefix", default="rpi-zero")
    parser.add_argument("--user-prefix", default="student")
    parser.add_argument("--fullname-prefix", default="Student")
